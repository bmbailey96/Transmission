...
exports.handler = async function (event) {
  ...
  const html = `<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Wikipedia backlog</title>
<style>
...
<h1>Wikipedia backlog (Jan-today, never scored)</h1>
<p><a href="/">&larr; back</a></p>
<p>${output.totalCandidates} releases from this year's Wikipedia list are already past their date and have never been scored at all. Processed ${output.processed} this run.</p>
